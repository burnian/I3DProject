...
bool I3DLib::Init3DLib(HINSTANCE hInstance, HWND hWnd, int width, int height)
{
...
int I3DLib::DrawPixel(int x, int y, DWORD color)
{
	// 创建并初始化锁定区域
	D3DLOCKED_RECT lr;
